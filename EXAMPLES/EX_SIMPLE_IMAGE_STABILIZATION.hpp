    ...
    while(1)
    {
	   ...
	   //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	    ...
	    //It uses global summation to test the alignment strength between the edge image and key-frame resulting from each shift
			...
			scamp7_kernel_end();
			scamp7_shift(S4,alignment_x,alignment_y);
			...
			for (int n = 0; n < 5; n++)
			{
				...
				scamp7_kernel_begin();
					MOV(S6,S4);
				scamp7_kernel_end();
				scamp7_shift(S6,shift_x,shift_y);
				...
				direction_global_sums[n] = scamp7_global_sum_64(C);
	   ...
	   //OUTPUT
			...
			output_timer.reset();
			{
				...
				scamp7_kernel_end();
				scamp7_shift(S6,alignment_x+1,alignment_y); //Shift the copy according to the current estimated alignment
				scamp7_kernel_begin();
				...
				{
					scamp7_output_image(DREG_current_edge_image,display_01);
				}
