...
int main()
{
    ...
    vs_handle display_01 = vs_gui_add_display("Shifted ADC data Image (DNEWS)",0,display_size,display_size);
    vs_handle display_02 = vs_gui_add_display("Shifted Image (NEWS)",0,display_size*2,display_size);

    vs_handle display_10 = vs_gui_add_display("ADC Image Data Bit 0",display_size,display_size+0,1);
    vs_handle display_11 = vs_gui_add_display("ADC Image Data Bit 0",display_size,display_size+1,1);
    vs_handle display_12 = vs_gui_add_display("ADC Image Data Bit 0",display_size,display_size+2,1);
    vs_handle display_13 = vs_gui_add_display("ADC Image Data Bit 0",display_size,display_size+3,1);
    ...
    while(1)
    {
		...
		//RETRIEVE 4-BIT IMAGE INTO AREG FROM SHIFTED DREG DATA
			...
			{
				scamp7_in(C,-127);//Retrieved image will be placed into C
				scamp7_in(E,127);
				scamp7_kernel_begin();
		...
		//OUTPUT IMAGES
			...
			scamp7_output_image(S2,display_11);
			scamp7_output_image(S1,display_12);
			scamp7_output_image(S0,display_13);
